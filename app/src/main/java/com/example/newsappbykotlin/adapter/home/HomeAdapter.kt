package com.example.newsappbykotlin.adapter.home
...
class HomeAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    private var  mDataList:List<HomeItem>
    ...
    constructor(mDataList: List<HomeItem>) : super() {
    ...
    override fun onBindViewHolder(holderMy: RecyclerView.ViewHolder, position: Int) {
        if(holderMy is MyViewHolder) {
            ...
            val data: HomeItem = mDataList.get(position)
            view.mtitle.setText(data.mData.title)

            var content:String = data.mData.content
            content = MyUtils.eraseBracketsInString(content)
            view.mcontent.setText(content)
            val imgUrl:String = data.mData.pic
